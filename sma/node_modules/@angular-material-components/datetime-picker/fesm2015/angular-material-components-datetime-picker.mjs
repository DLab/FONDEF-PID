...
class NgxMatTimepickerComponent {
    ...
    setTime(first) {
      /** @type {?} */
      const _hour = first ? '00' : '23';
      const _ms = first ? '00' : '59';
      this.form.controls['hour'].setValue(_hour);
      this.form.controls['minute'].setValue(_ms);
      this.form.controls['second'].setValue(_ms);
      this._updateModel();
    }
...
class NgxMatDatetimeInput {
    ...
    _onInput(value) {
        ...
        //cambio jmc
        var _format = this._datepicker.formatInputDate ? this._datepicker.formatInputDate : this._dateFormats.display.dateInput;
        let date = this._dateAdapter.parse(value, _format);
    ...
    _formatValue(value) {
        ...
        this._elementRef.nativeElement.value =
            value ? this._dateAdapter.format(value, _format) : '';
    }
    /**
     * @param obj The object to check.
     * @returns The given object if it is both a date instance and valid, otherwise null.
