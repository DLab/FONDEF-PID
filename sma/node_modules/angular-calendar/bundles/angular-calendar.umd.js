(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-calendar'] = {}, global.ng.core, global.ng.common, global.positioning, global.rxjs, global.rxjs.operators, global.calendarUtils, global['angular-draggable-droppable'], global.ng.animations, global['angular-resizable-element']));
  ...
  ***************************************************************************** */
  ...
  var CalendarAngularDateFormatter = /** @class */ (function () {
      ...
      CalendarAngularDateFormatter.prototype.weekViewTitle = function (_a) {
          ...
          var format = function (dateToFormat, showYear) { return common.formatDate(dateToFormat, 'MMM d' + (showYear ? ', yyyy' : ''), locale); };
  ...
  var ClickDirective = /** @class */ (function () {
      function ClickDirective(renderer, elm, document) {
          ...
          this.click = new core.EventEmitter(); // eslint-disable-line
  ...
  var KeydownEnterDirective = /** @class */ (function () {
      function KeydownEnterDirective(host, ngZone, renderer) {
          ...
          this.ngZone = ngZone;
          this.renderer = renderer;
          this.keydown = new core.EventEmitter(); // eslint-disable-line
  ...
  KeydownEnterDirective.decorators = [
      { type: core.Directive, args: [{
  ...
  KeydownEnterDirective.propDecorators = {
      keydown: [{ type: core.Output, args: ['mwlKeydownEnter',] }]
  };
  ...
  CalendarWeekViewComponent.propDecorators = {
      ...
      hourDuration: [{ type: core.Input }],
      hourSegmentHeight: [{ type: core.Input }],
      minimumEventHeight: [{ type: core.Input }],
      ...
      daysInWeek: [{ type: core.Input }],
      currentTimeMarkerTemplate: [{ type: core.Input }],
      validateEventTimesChanged: [{ type: core.Input }],
  ...
  CalendarWeekViewCurrentTimeMarkerComponent.decorators = [
      { type: core.Component, args: [{
